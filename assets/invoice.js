  ...
  *, ::before, ::after{
  ...
  @media print {
    ...
    .watermark {
      ...
      top: 50%;
      left: 50%;
      transform: translate(-50%, -50%) scale(1.3); /* Adjust zoom */
      opacity: 0.08;
      pointer-events: none;
      z-index: 0;
      max-width: 80%;
  ...
  <body>
    <div class="content">
      <div class="payslip-container" id="payslip-container" style="position: relative;">
        <img class="watermark" src="https://res.cloudinary.com/dtwcxssvj/image/upload/v1747045955/SourceOnebg_s17wiy.png"  alt="Watermark" />
        <div class="py-4">
